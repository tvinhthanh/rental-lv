    ...
    const { data: statsData, isLoading: statsLoading, error: statsError } = useQuery({
        ...
        queryFn: async () => {
            ...
            // Only load essential data with limits to improve performance
                ...
                // Limit invoices for revenue calculation
