...
import SurchargeCard from "../../../(admin-group)/admin/surcharges/_components/SurchargeCard";
import SurchargeModal from "../../../(admin-group)/admin/surcharges/_components/SurchargeModal";
...
function SurchargesContent() {
    ...
    useEffect(() => {
        ...
        async function loadSurcharges() {
            try {
                setLoading(true);
                const res = await billingService.surchargesByBranch(employee.branchId);
