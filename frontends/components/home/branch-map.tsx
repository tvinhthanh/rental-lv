      ...
      <div className="max-w-6xl mx-auto relative px-4">
        <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-3xl font-bold text-white">Đón xe tại vị trí thuận tiện</h2>
            </div>
          </div>
          <a
            href="/user/cars"
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl border border-white/10">
          <iframe
            ...
            loading="lazy"
            allowFullScreen
            // Sử dụng embed URL hợp lệ, có thể thay bằng chi nhánh thực tế
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.403987842262!2d106.70062717631097!3d10.779783159135654!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f3de6127f75%3A0x5cf9353e8542fa74!2zTmdoIMO0IEPDtG5nIFRoxqFuZyBUaMO0bmcgUXXhuq1uIDE!5e0!3m2!1svi!2s!4v1700000000000!5m2!1svi!2s"
          ></iframe>
        </div>
      </div>
    </section>
